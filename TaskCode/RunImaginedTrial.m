...
OptimalCursorTraj = [];
OptimalCursorTraj(:,1) = linspace(...
    Cursor.Position(1),...
    Cursor.Position(1),...
    Params.RefreshRate*Params.InterTrialInterval); % hold at start
OptimalCursorTraj(:,2) = linspace(...
    Cursor.Position(2),...
    Cursor.Position(2),...
    Params.RefreshRate*Params.InterTrialInterval); % hold at start
ct = 1;
...
OptimalCursorTraj = [];
OptimalCursorTraj(:,1) = [...
    linspace(Cursor.Position(1),...
   	StartTargetPos(1),...
    Params.RefreshRate*1),...
    linspace(StartTargetPos(1),...
    StartTargetPos(1),...
    Params.RefreshRate*Params.TargetHoldTime),...
    ]; % hold at start
OptimalCursorTraj(:,2) = [...
    linspace(Cursor.Position(2),...
   	StartTargetPos(2),...
    Params.RefreshRate*1),...
    linspace(StartTargetPos(2),...
    StartTargetPos(2),...
    Params.RefreshRate*Params.TargetHoldTime),...
    ]; % hold at start
ct = 1;
...
OptimalCursorTraj(:,1) = linspace(...
    StartTargetPos(1),...
    StartTargetPos(1),...
    Params.RefreshRate*Params.InstructedDelayTime); % hold at start
OptimalCursorTraj(:,2) = linspace(...
    StartTargetPos(2),...
    StartTargetPos(2),...
    Params.RefreshRate*Params.InstructedDelayTime); % hold at start

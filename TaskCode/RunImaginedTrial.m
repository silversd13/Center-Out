function [Data, Neuro] = RunImaginedTrial(Data,Params,Neuro)
...
if ~Data.ErrorID,
    ...
    while ~done,
        ...
        if (tim-tlast) > 1/Params.RefreshRate,
            ...
            % cursor
            if ~Params.CenterReset, Cursor = UpdateCursor(Params,Cursor,dt,OptimalCursorTraj(ct,:));
